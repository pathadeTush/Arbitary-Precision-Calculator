...
int main()
{
    ...
    if (in->data == 'o' - '0')
    {
        ...
        {
            printf("BadInputError : 'b' is expected after 'o' in line 1\n");
            return 0;
        }
        ...
        {
            printf("SyntaxError : '=' operator is  expected after 'b' in line 1\n");
            return 0;
        }
        ...
        {
            printf("BadInputError : base is expected either 2 or 8\n");
            return 0;
        }
        ...
        {
            printf("SyntaxError : ';' is expected after 2\n");
            return 0;
        }
        ...
        {
            printf("SyntaxError : space expected after ';'\n");
            return 0;
        }
        ...
        if (isDigit(in->next->data) && in->next->data != -2)
        {
            ...
            NUM res = NULL;
            if (t == 2)
                res = DecimaToBinary(&num);
            if (t == 8)
                res = DecimaToOctal(&num);
            printf("output : ");
            traverse_expr(res);
            return 0;
        }
    ...
    if ((!isDigit(in->data) || in->data == -2) && in->data != '-' - '0' && in->data != '(' - '0')
    {
        printf("SyntaxError : ");
